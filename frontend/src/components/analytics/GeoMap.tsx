...
export function GeoMap({ data }: GeoMapProps) {
    ...
    return (
        <Card className="bg-[#262626] border-[#333333] backdrop-blur-sm rounded-3xl p-6">
            ...
            {/* Summary */}
            {points.length > 0 && (
                <div className="mt-6 flex flex-wrap items-center gap-3 md:gap-4 text-xs md:text-sm">
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-cyan-500 shrink-0"></div>
                        <span className="text-zinc-400 whitespace-nowrap">&gt;20% доли - лидеры</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-purple-500 shrink-0"></div>
                        <span className="text-zinc-400 whitespace-nowrap">10-20% - средние</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-full bg-zinc-600 shrink-0"></div>
                        <span className="text-zinc-400 whitespace-nowrap">&lt;10% - малые</span>
                    </div>
                </div>
            )}
        </Card>
